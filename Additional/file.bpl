...
implementation {:verboseName "Main (correctness)"} Impl$$_module.__default.Main() returns ($_reverifyPost: bool)
{
  ...
  var y#0: int;
    ...
    $_reverifyPost := false;
    // ----- assignment statement ----- C:\HOME\Licenta\Dafny-programs\Dafny\Additional\boogieTest.dfy(2,11)
    assume true;
    assume true;
    x#0 := LitInt(5);
    // ----- assignment statement ----- C:\HOME\Licenta\Dafny-programs\Dafny\Additional\boogieTest.dfy(3,11)
    assume true;
    assume true;
    y#0 := LitInt(10);
    // ----- assert statement ----- C:\HOME\Licenta\Dafny-programs\Dafny\Additional\boogieTest.dfy(4,5)
    assume true;
